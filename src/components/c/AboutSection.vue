        ...
        <div class="px-4 pt-12 lg:pt-0 lg:pl-36 flex flex-col">
            ...
            <div ref="slideDown"
                ...
                <div class="w-fit flex lg:flex-col items-center text-white translate-x-[-20px] lg:translate-y-[-140px]">
                    ...
                    <span class="font-bold md:text-xl lg:lg:opacity-0 opaque absolute lg:static bottom-[-10px] right-0">
                        Pièces neuves
                    </span>
                </div>
                <div class="w-fit flex lg:flex-col items-center text-white translate-x-[-20px] lg:translate-y-[-150px]">
                    ...
                    <span class="font-bold md:text-xl lg:opacity-0 opaque absolute lg:static bottom-[-10px] right-0">
                        Voiture d'occasions
                    </span>
                </div>
                <div class="w-fit flex lg:flex-col items-center text-white translate-x-[-20px] lg:translate-y-[-130px]">
                    ...
                    <span class="lg:text-[6rem] font-semibold w-[250px] text-center hidden lg:block">
                        <span class="opaque">+</span><span ref="events" id="events" class="number">85</span>
                    </span>
                    <span class="ml-4 text-[4rem] md:text-[5rem] lg:hidden"><span class="opaque">+</span>
