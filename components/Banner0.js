    ...
    return (
        <div className={`flex justify-center items-center h-screen ${styles.darkBackground}`}>
            <div className="flex flex-wrap items-center justify-center h-full md:justify-between">
                <div className="flex flex-col justify-center items-start w-full md:w-1/2 md:items-center">
                    <h1 data-w-id="4fd1001e-0883-42e7-af04-a12016ec15d7" className={` ${styles.textleft}`}>
                        <Link href="/centre-de-depollution" className={styles.textwhity}>Centre de dépollution</Link>
                    </h1>
                    <div className="arrows-animated-wrapper">
                        <Link href="/centre-de-depollution">
                            <Image
                ...
                <div className="flex flex-col justify-center items-end w-full md:w-1/2 md:items-center">
                    <h1 data-w-id="4fd1001e-0883-42e7-af04-a12016ec15d7" className={`home-title ${styles.textright}`}>
                        <Link href="/garage-atelier-mecanique" className={styles.textwhity}>Atelier mécanique</Link>
                    </h1>
                    <div className="arrows-animated-wrapper">
                        <Link href="/garage-atelier-mecanique">
                            <Image
                                src="/images/arrow-outlone.svg"
                                loading="lazy"
                                alt="icon"
